	...
	useEffect(() => {
		...
		const cycle = () => {
			...
			timeoutId = setTimeout(() => {
				...
				setVisible(true);
			}, 220); // duration should match animation class
		};
							...
							<span className="inline-block align-baseline">
								...
								<span
									className={cn(
										...
										reducedMotion ? "opacity-100" : visible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-1.5",
										reducedMotion ? "" : "transition-all duration-200 will-change-transform"
									)}
									key={index}
								>
									{rotatingWords[index]}
